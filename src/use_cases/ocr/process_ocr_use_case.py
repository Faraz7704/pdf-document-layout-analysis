...
class ProcessOCRUseCase:
    ...
    def execute(self, file: UploadFile, languages: str | list[str] = "en") -> FileResponse:
        namespace = "sync_pdfs"
        ...
        processed_pdf_filepath = self.ocr_service.process_pdf_ocr(file.filename, namespace, languages)
